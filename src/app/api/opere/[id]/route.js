const poezii = [
  {
    ...
    an: 1883,
    publicatie: 'Almanahul Societății Studențești „România Jună"',
    teme: ['Tema cosmică', 'Iubire absolutā', 'Geniu', 'Timp'],
    imagine: '/assets/opere2/luceafarul.jpg',
    strofe: [
      [
      ...
      [
        ...
        'But noptile-s de-un farmec sfânt',
  ...
  },
  {
    ...
    autor: 'Mihai Eminescu',
    an: 1873,
    publicatie: 'Revista „Convorbiri literare”',
    teme: ['Condiția nefericită a geniului', 'Natură și iubire', 'Timpul trecător'],
    imagine: '/assets/opere2/floare_albastra.jpg',
    strofe: [
      [
  ...
  },
  {
    ...
    an: 1885,
    publicatie: 'Revista „Convorbiri literare”',
    teme: ['Natură și iubire', 'Dorul', 'Idilă', 'Timpul cosmic'],
    imagine: '/assets/opere2/sara_pe_deal.jpg',
    strofe: [
      [
  ...
  },
  {
    ...
    autor: 'Mihai Eminescu',
    an: 1867,
    publicatie: 'Revista „Familia”',
    teme: ['Patriotismul', 'Istoria', 'Destinul național', 'Idealul de glorie'],
    imagine: '/assets/opere2/ce-ti-doresc-eu-tie-dulce-romanie.jpg',
    strofe: [
      [
  ...
  },
  {
    ...
    an: 1884,
    publicatie: 'Revista „Convorbiri literare”',
    teme: ['Natura și timpul', 'Melancolia', 'Singurătatea', 'Trecerea ireversibilă a timpului'],
    imagine: '/assets/opere2/ce-te-legeni.jpg',
    strofe: [
      [
